...
\begin{tabular}{llllll}
    ...
    {% for dynamic_ex in day.dynamic_exercises %}
        ...
        {{dynamic_ex._progress_information(program)[0]|round2digits}} {{program.units}} &
        {{dynamic_ex._progress_information(program)[1]|round2digits}} {{program.units}} & 
        {{dynamic_ex._min_max_reps(program)[0]}} & {{dynamic_ex._min_max_reps(program)[1]}} &
        {{dynamic_ex._progress_information(program)[2]}}\%\\
    {% endfor %}
